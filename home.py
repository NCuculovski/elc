...
### END PASSWORD HERE
    ...
    def datamalt_demo():
        ...
        ***
        ...
        st.subheader("**Will the Lipstick Effect protect the industry this year?**")
        ...
        *Fabrizio Freda, President, Chief Executive Officer & Director, The Estée Lauder Companies, Inc.*, acknowledges that the *“prolonged pandemic, the invasion of Ukraine, and the onset of higher inflation”* are external factors and considerations affecting business performance.
        ...
        Regardless of the macroeconomic situation, the category and its main players including Estée Lauder are starting to have visible downshift in stock performance. To battle such forces, we need additional optimization levers that will enable budget fluidity and flexibility.
        ...
        ***
        ...
        st.markdown(' ')
        st.markdown('- The current sample protoype data was scraped from Douglas Cosmetics - a perfume and cosmetics retailer for illustration purposes. In production, we will collect all places where Estée Lauder products are sold.')
        st.markdown('- Each dot on the map is a Douglas location across Germany, Spain, and Austria (sample).')
        ...
        st.markdown('- The North-West Region of Germany indicates high density of Douglas establishments which may require different marketing treatment as compared to other parts of the country.')
        st.markdown('- Douglas has central and North-East penetration in Spain. This insight may also be indicative for certain consumption habits in those regions.')
        st.write("")
